...
$select = $banco->query  ("SELECT * FROM Anotacao Where Id_login = '$id' ");

$Valor = $select -> fetchAll(PDO::FETCH_OBJ);
...
<tr>
    <td>Titulo: <?php echo $date->Titulo ?></td>
    <hr>
    <td>Texto: <?php echo $date->Texto ?></td>
    <hr>
    <td>Assinatura: <?php echo $date->Assinatura ?></td>
    <hr>
</tr>
